...
<div class="row g-3 mb-4">
    <div class="col-md-3 col-sm-6">
        <a href="admin-jobs.php?status=all&page=1" class="text-decoration-none">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="admin-users.php?status=all&page=1" class="text-decoration-none">
            <div class="stat-card hover-lift">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="admin-companies.php?status=pending&page=1" class="text-decoration-none">
            <div class="stat-card hover-lift">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="support-messages.php?filter=unread" class="text-decoration-none">
            <div class="stat-card hover-lift">
    ...
    <div class="col-md-3 col-sm-6">
        <a href="company-verifications.php?status=pending&page=1" class="text-decoration-none">
            <div class="stat-card hover-lift">
    ...
    <div class="col-12">
        <div class="row g-3">
            <div class="col-md-4 col-sm-6">
                <a href="admin-jobs.php?status=pending&page=1" class="text-decoration-none">
                    <div class="card shadow-sm h-100 border-0 hover-lift">
                        <div class="card-body">
                            <h5>Manage Jobs</h5>
                            <p class="text-muted small mb-0">Review pending jobs and approve or reject them</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="admin-companies.php?status=pending&page=1" class="text-decoration-none">
                    <div class="card shadow-sm h-100 border-0 hover-lift">
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-0">Approve / reject company registrations</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="admin-users.php?status=all&page=1" class="text-decoration-none">
                    <div class="card shadow-sm h-100 border-0 hover-lift">
                        <div class="card-body">
                            <h5>Manage Users</h5>
                            <p class="text-muted small mb-0">View and manage job seekers</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="company-verifications.php?status=pending&page=1" class="text-decoration-none">
                    <div class="card shadow-sm h-100 border-0 hover-lift">
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-0">Approve or reject company verification requests</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="activity-monitor.php" class="text-decoration-none">
                    <div class="card shadow-sm h-100 border-0 hover-lift">
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-0">Platform events in the last 7 days: <?= (int)$stats['recent_activities'] ?></p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="support-messages.php" class="text-decoration-none">
                    <div class="card shadow-sm h-100 border-0 hover-lift">
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-0">Review support requests, reply and resolve issues</p>
                        </div>
                    </div>
                </a>
            </div>
...
.hover-lift:hover { transform: translateY(-3px); box-shadow: 0 24px 48px rgba(2,6,23,0.45) !important; }
</style>
