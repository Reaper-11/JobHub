...
if ($companyId <= 0) {
    header("Location: company-verifications.php?status=all&page=1");
    exit;
}
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="company-verifications.php?status=all&page=1" class="btn btn-outline-secondary">Back</a>
</div>
